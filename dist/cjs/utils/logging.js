...
exports.logger = exports.FrontendLogger = void 0;
...
exports.logger = getLogger('frontend-lib');
// Development utilities for debugging
if (typeof window !== 'undefined') {
    // Add global debug functions
    window.getFrontendLogs = () => exports.logger.exportLogs();
    window.clearFrontendLogs = () => exports.logger.clearLogs();
    window.viewLogs = () => {
        console.table(JSON.parse(exports.logger.exportLogs()));
    };
}
